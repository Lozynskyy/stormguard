<?php
    $get_started_section_title = get_field('get_started_section_title', 'option');

    $get_started_section_description = get_field('get_started_section_description', 'option');

    $get_started_section_residential_link = get_field('get_started_section_residential_link', 'option');

    $get_started_section_commercial_link = get_field('get_started_section_commercial_link', 'option');

    $get_started_section_insurance_link = get_field('get_started_section_insurance_link', 'option');
?>
